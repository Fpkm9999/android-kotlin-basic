...
class MainActivity_ContextBox_04 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button.setOnClickListener {
            ...
            val dlg = AlertDialog.Builder(this@MainActivity_ContextBox_04)
            dlg.setTitle(/* title = */ "좋아하는 버전은?.")
            dlg.setIcon(R.mipmap.ic_launcher)
            dlg.setMultiChoiceItems(versionArray,checkArray) { _, which,inChecked ->
